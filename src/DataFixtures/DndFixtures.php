...
class DndFixtures extends Fixture
{
    public function load(ObjectManager $manager)
    {
        ...
        $data = [
            ...
            ['Armor', 'Light armor', 'Leather', 'leather.png', 1000, 10, '', '', '', '11 + Dex modifier', null, 'Disadvantage', null, null],
            ...
            ['Armor', 'Medium armor', 'Half plate', 'half-plate.png', 75000, 40, '', '', '', '15 + Dex modifier (max 2)', null, '', null, null],
            ...
            ['Armor', 'Shield', 'Shield', 'shield.png', 1000, 6, '', '', '', '+2', 15, 'Disadvantage', null, null],
